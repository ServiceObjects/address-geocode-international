import { PlaceSearchSoap } from '../address-geocode-international/SOAP/place_search_soap.js';

async function PlaceSearchSoapGo(licenseKey, isLive) {
    console.log("\n------------------------------------------------------");
    console.log("Address Geocode International - PlaceSearch - SOAP SDK");
    console.log("------------------------------------------------------");
