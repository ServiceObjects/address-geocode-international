...
{
    internal static class ReverseSearchSoapSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n--------------------------------------------------------");
            Console.WriteLine("Address Geocode International - ReverseSearch - SOAP SDK");
            Console.WriteLine("--------------------------------------------------------");

            // Input parameters
            string latitude = "40.7128";
            string longitude = "-74.0060";
            string searchRadius = "20";  // default radius
            string country = "US";       // specify country or empty string for any
            string maxResults = "2";    // max results
            string searchType = "All";   // search type, e.g. "All"

            // Print inputs
            Console.WriteLine("\r\n* Input *\r\n");
            Console.WriteLine("Latitude    : " + latitude);
            Console.WriteLine("Longitude   : " + longitude);
            Console.WriteLine("SearchRadius: " + searchRadius);
            Console.WriteLine("Country     : " + country);
            Console.WriteLine("MaxResults  : " + maxResults);
            Console.WriteLine("SearchType  : " + searchType);
            Console.WriteLine("Is Live     : " + isLive);
            Console.WriteLine("LicenseKey  : " + licenseKey);

            ReverseSearchValidation reverseSearchValidation = new(isLive);

            AGIService.ResponseObject response = reverseSearchValidation.ReverseSearch(
                latitude,
                longitude,
                licenseKey,
                searchRadius,
